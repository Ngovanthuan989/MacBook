...
<style>
    ...
    <div class="container">
                      ...
                      <div class="form-group">
                        ...
                        <div class="avatar-cs" style="margin-bottom: 30px;">
                            <div class="preview" data-a="" style="border: 1px dashed rgb(67, 158, 215);">
                                <img id="preview" class="preview_img img-round" src="{{asset('/uploads/images/'.$edit_product->product_img.'')}}">
            ...
            <button type="submit" class="btn btn-primary"><i class="fas fa-plus"></i> Cập nhập</button>
        </form>
    </div>
